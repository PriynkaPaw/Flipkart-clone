  ...
  async () => {
    try {
      const response = await axios.get(
        "http://localhost:4441/api/v1/subCategory"
      );
...
export const subCatById = createAsyncThunk(
  GET_SUB_CATEGORY_ID.get_Sub_category_id,
  async (val) => {
    try {
      const response = await axios.get(
        `http://localhost:4441/api/v1/subCategory${val.id}`
      );
