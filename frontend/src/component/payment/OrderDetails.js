...
function OrderDetails() {
    ...
    const productDetails = productList.find((productID)=> productID._id== prodcutId)
...
// console.log('userData: ', userData);
  ...
  return (
    ...
    <div className='ml-[35%] bg-gray-100 w-[450px] h-auto mt-[100px]'>
        <div>
            <h1 className='text-2xl text-red-500 ml-[130px] pt-4'>Order Details</h1>
            ...
            <div className='ml-[50px]'>
                ...
                <h1>{userData?.apartment},<span> {userData?.street}, {userData?.city}, {userData?.country}, {userData?.zip} </span> </h1>
                <h1>Phone: <span>{userData?.phone}</span> </h1> 
            </div>
        </div>
