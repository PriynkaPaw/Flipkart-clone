...
function Admin() {
    ...
    console.log("getRolesList: ", getRolesList);
    ...
    const handleDeletePermission = (item) => {
        ...
        console.log("item(Permission) Iddd", item);
    };
                                ...
                                {users &&
                                    users.map((item) => (
                                        <div className="border h-[50px] flex mt-4">
                                         ...
                                         <h1  className="text-pink-600 text-xl ml-[8%] mt-2">{item?.role}</h1>
                        ...
                        <ul>
                            {product?.map((item) => (
                                <div className="bg-gray-200 mb-2 h-[200px] mt-2 flex border border-gray-300">
                                    <img className="h-[150px] w-[150px] mt-6" src={item.image} />
